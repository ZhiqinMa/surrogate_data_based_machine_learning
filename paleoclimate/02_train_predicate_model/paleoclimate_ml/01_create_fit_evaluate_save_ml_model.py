...
if __name__ == '__main__':
    ...
    full_path = 'G:/surrogate_data_based_machine_learning_v4.0.0/paleoclimate/01_data_preprocessing/02_extracte_and_generate_surrogate_dataset/{}/data/merge_surrogate_{}_simples_{}_train_{}.csv'.format(Data_folder, surr_type, simples, ID_train)
