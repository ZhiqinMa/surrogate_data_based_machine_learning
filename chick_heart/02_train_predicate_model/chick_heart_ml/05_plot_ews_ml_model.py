...
df_SD_probability.to_csv("05_data_ews/{}/prediction_probability_surrogate_{}_simples_{}_test_{}_{}.csv".format(surr_type, surr_type, simples, ID_test, ML_model), header=True, index=False)
...
# save figure
plt.savefig('05_figures_ews/{}/{}_surrogate_{}_train_{}_test_{}_simples_{}_{}.png'.format(surr_type, Record_Core, surr_type, ID_train, ID_test,
