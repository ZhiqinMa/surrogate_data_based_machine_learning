...
if __name__ == '__main__':
    ...
    filename = '../../01_data_preprocessing/01_organise__transition__ews/data/02_ews/anoxia_df_ews.csv'
    ...
    # select columns
    dataframe = dataframe[[df_ews_column_Age, df_ews_column_state]][
        (dataframe['tsid'] == tsid) & (dataframe['Variable_label'] == Variable_label)]
    # review shape
