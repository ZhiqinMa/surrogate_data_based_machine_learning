...
# 8 parameters to set:  surr_type=str, simples=int, ID_train=str, ID_test=str,
                        Variable_label= str, ML_model=str, sw_width=int, tsid=int,
...
# select columns
df_transitions = df_transitions[[df_transitions_column_Age, df_transitions_column_state]][
    (df_transitions['tsid'] == tsid)]
df_ews = df_ews[[df_ews_column_Age, df_ews_column_state]][
    (df_ews['tsid'] == tsid) & (df_ews['Variable_label'] == Variable_label)]
# print(df_transitions)
...
df_SD_probability.to_csv("05_ews_data_and_figures/data/{}/prediction_probability_surrogate_{}_simples_{}_test_{}_{}.csv".format(surr_type, surr_type, simples, ID_test,
                                                                                    ML_model), header=True, index=False)
...
ax[1].set_ylabel('SD probability', fontsize=14)
...
# save figure
plt.savefig(
    '05_ews_data_and_figures/figures/{}/{}_surrogate_{}_train_{}_test_{}_simples_{}_{}.png'.format(surr_type, Record_Core, surr_type, ID_train, ID_test,
                                                                            simples, ML_model), dpi=300)
# Show plot
# plt.show()
