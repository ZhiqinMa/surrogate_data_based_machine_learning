...
df_SD_probability.to_csv(
    "05_ews_data_and_figures/data/{}/prediction_probability_surrogate_{}_simples_{}_test_{}_{}.csv".format(surr_type, surr_type, simples, ID_test,
