...
# path + name
file_path = "../../../01_organise__transition__ews/data/02_ews/anoxia_df_ews.csv"
# load data
...
df = df[[column_Age, column_state]][(df['tsid'] == tsid) & (df['Variable_label'] == Variable_label)]
# review shape
