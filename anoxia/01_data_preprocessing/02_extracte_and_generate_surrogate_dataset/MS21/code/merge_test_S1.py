...
# passing parameters
tsid_S1 = int(sys.argv[1])              ## (Set it up to your needs)
ID_test_S1 = str(sys.argv[2])           ## (Set it up to your needs)
...
# Path
path_4 = "../data/0{}_surrogate_{}_simples_{}_period_{}.csv".format(tsid_S1, surr_type, simples, ID_test_S1)
# load dataset
...
# save dataframe file
df.to_csv("../data/merge_surrogate_{}_simples_{}_test_{}.csv".format(surr_type, simples, ID_test_S1),
