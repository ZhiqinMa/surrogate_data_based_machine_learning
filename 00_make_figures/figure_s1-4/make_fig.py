...
# MS21-S1
df_ml_ms21_s1 = pd.read_csv(f'input_data/ml_preds/MS21/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_10000_test_S1_CNN_model.csv')

# MS66-S1
df_ml_ms66_s1 = pd.read_csv(f'input_data/ml_preds/MS66/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_S1_SVM_model.csv')
# MS66-S3
df_ml_ms66_s3 = pd.read_csv(f'input_data/ml_preds/MS66/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_S3_SVM_model.csv')

# 64PE-S3
df_ml_64pe_s3 = pd.read_csv(f'input_data/ml_preds/64PE/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_S3_LSTM_model.csv')
# 64PE-S4
df_ml_64pe_s4 = pd.read_csv(f'input_data/ml_preds/64PE/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_S4_LSTM_model.csv')
# 64PE-S5
df_ml_64pe_s5 = pd.read_csv(f'input_data/ml_preds/64PE/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_10000_test_S5_LSTM_model.csv')
# 64PE-S6
df_ml_64pe_s6 = pd.read_csv(f'input_data/ml_preds/64PE/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_S6_LSTM_model.csv')

# End of glaciation I
df_ml_paleoclimate_I = pd.read_csv(f'input_data/ml_preds/paleoclimate/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_10000_test_I_SVM_model.csv')
# End of glaciation II
df_ml_paleoclimate_II = pd.read_csv(f'input_data/ml_preds/paleoclimate/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_10000_test_II_SVM_model.csv')

# PII
df_ml_tree_felling_PII = pd.read_csv(f'input_data/ml_preds/tree_felling/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_PII_three_head_CNN_model.csv')
# Early PIII
df_ml_tree_felling_Early_PIII = pd.read_csv(f'input_data/ml_preds/tree_felling/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_EPIII_three_head_CNN_model.csv')
# Late PIII
df_ml_tree_felling_Late_PIII = pd.read_csv(f'input_data/ml_preds/tree_felling/05_ews_data_and_figures/data/{surr_type}/prediction_probability_surrogate_{surr_type}_simples_1000_test_LPIII_three_head_CNN_model.csv')
...
dst.save(filepath + '../figure_s{}_{}.png'.format(fig_id, surr_type))
