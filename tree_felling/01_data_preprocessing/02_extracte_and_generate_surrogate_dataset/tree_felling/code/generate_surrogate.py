...
# # Setting parameters
# tsid = 0                      ## (Set it up to your needs)
# Period = "BMIII"              ## (Set it up to your needs)
# simples = 1000                ## (Set it up to your needs)
# surr_type = 'AAFT'            ## (Set it up to your needs)
# n_features = 100              ##  sliding window    # n=184
...
# path + name
file_path = r"../../../01_organise__transition__ews/data/03_ews/tree_felling_df_ews.csv"
# file_path = r"F:\PycharmProject\ews_deep_learning_via_surrogate_data_v6.0.0\tree_felling\01_data_preprocessing\01_organise__transition__ews\data\03_ews\tree_felling_df_ews.csv"
# load data
...
if surr_type == "WIAAFT":
    ...
    from julia import TimeseriesSurrogates  # 加载julia函数
else:
...
# save file
surr_df.to_csv("../data/0{}_surrogate_{}_simples_{}_period_{}.csv".format(tsid, surr_type, simples, Period),
               header=False,
               index=False)
