...
if __name__ == '__main__':
    ...
    filename = '../../01_data_preprocessing/01_organise__transition__ews/data/03_ews/tree_felling_df_ews.csv'
    # load the csv file as a data frame
    dataframe = read_csv(filename, header=0)

    # select columns
    dataframe = dataframe[['Age', 'state']][(dataframe['Period'] == ID_test) & (dataframe['tsid'] == tsid)]
    # review shape
