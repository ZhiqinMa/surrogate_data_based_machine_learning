...
if __name__ == '__main__':
    ...
    # full_path = 'F:/PycharmProject/ews_deep_learning_via_surrogate_data_v6.0.0/tree_felling/01_data_preprocessing/02_extracte_and_generate_surrogate_dataset/{}/data/merge_surrogate_{}_simples_{}_train_{}.csv'.format(Data_folder, surr_type, simples, ID_train)
